...
import pytest
from gpax.kernels import RBFKernel, Matern12Kernel, Matern32Kernel, Matern52Kernel, PolynomialKernel
...
def test_initialize(kernel_fn, kernel_params):
    ...
    params = kernel.initialize_params(key, X)
...
def test_combinations():
    ...
    params = kernel.initialize_params(key=jax.random.PRNGKey(0), X=X)
